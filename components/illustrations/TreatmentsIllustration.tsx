import Svg, { Circle, Defs, Ellipse, LinearGradient, Path, Polygon, Rect, Stop, G } from 'react-native-svg'

export default function TreatmentsIllustration() {
  return (
    <Svg data-name='Layer 1' width='200' height='150' viewBox='0 0 1105.04 782.74'>
      <Defs>
        <LinearGradient
          id='ac3cc305-f6db-42f4-bbbd-32121ee27a74-66'
          x1='403.57'
          y1='833.5'
          x2='403.57'
          y2='218.16'
      ...
      <Ellipse cx='367.38' cy='766.65' rx='97.44' ry='15.65' fill='#ad164d' opacity='0.1' />
      <Ellipse cx='897.05' cy='767.09' rx='121.59' ry='15.65' fill='#ad164d' opacity='0.1' />
      <Path
      ...
      <Polygon
        ...
        opacity='0.1'
      />
      <Rect x='139.57' y='338.19' width='76.3' height='138.33' fill='#ad164d' opacity='0.1' />
      <Path
        ...
        opacity='0.1'
      />
      <Rect x='629.96' y='194.56' width='62.92' height='139.35' fill='#ad164d' opacity='0.1' />
      <Polygon
      ...
      <Path
        ...
        opacity='0.1'
      />
      <Rect x='659.18' y='233.3' width='33.71' height='43.69' fill='#ad164d' opacity='0.1' />
      <Rect x='659.18' y='323.86' width='33.71' height='10.06' fill='#ad164d' opacity='0.1' />
      <Rect x='659.18' y='338.19' width='33.71' height='29.35' fill='#ad164d' opacity='0.1' />
      <Rect x='659.18' y='414.42' width='33.71' height='43.69' fill='#ad164d' opacity='0.1' />
      <Rect x='659.18' y='504.98' width='33.71' height='43.69' fill='#ad164d' opacity='0.1' />
      <Path
      ...
      <Path
        ...
        opacity='0.1'
      />
      <Rect x='380.58' y='473.32' width='144.47' height='3.21' fill='#ad164d' opacity='0.1' />
      <Rect x='380.58' y='480.8' width='144.47' height='12.3' fill='#ad164d' opacity='0.1' />
      <Rect x='380.58' y='533.42' width='144.47' height='19.78' fill='#ad164d' opacity='0.1' />
      <Path
      ...
      <Path
        ...
        opacity='0.1'
      />
      <Rect x='775.83' y='351.6' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='160.05' y='219.09' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='160.05' y='285.15' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='160.05' y='351.21' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='160.05' y='417.26' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='160.05' y='483.32' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='160.05' y='549.38' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='884.4' y='351.6' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='775.83' y='421.75' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='884.4' y='421.75' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='775.83' y='491.89' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='884.4' y='491.89' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='775.83' y='562.04' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='884.4' y='562.04' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='775.83' y='632.19' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Rect x='884.4' y='632.19' width='28.44' height='28.44' fill='#ad164d' opacity='0.1' />
      <Polygon
      ...
      <Path
        ...
        transform='translate(-47.24 -58.63)'
        fill='url(#ac3cc305-f6db-42f4-bbbd-32121ee27a74-66)'
      />
      <Path
      ...
      <Ellipse cx='132.73' cy='744.94' rx='97.44' ry='15.65' fill='#ad164d' opacity='0.1' />
      ...
      <Path
        ...
        transform='translate(-47.24 -58.63)'
        fill='url(#ad14f186-b27f-416c-b629-0bafa2f1236e-67)'
      />
